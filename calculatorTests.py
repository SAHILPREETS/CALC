...
class MyTestCase(unittest.TestCase):
    ...
    def test_add_from_csv(self):
        ...
        y = self.calculator.read_csv("../src/CSV1/Unit Test Addition.csv")
    ...
    def test_subtraction(self):
        y = self.calculator.read_csv("../src/CSV1/Unit Test Subtraction.csv")
    ...
    def test_multiplication(self):
        ...
        y = self.calculator.read_csv("../src/CSV1/Unit Test Multiplication.csv")
    ...
    def test_division(self):
        y = self.calculator.read_csv("../src/CSV1/Unit Test Division.csv")
    ...
    def test_square(self):
        ...
        y = self.calculator.read_csv("../src/CSV1/Unit Test Square.csv")
    ...
    def test_squareRoot(self):
        y = self.calculator.read_csv("../src/CSV1/Unit Test Square Root.csv")
